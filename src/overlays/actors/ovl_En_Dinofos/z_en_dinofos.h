...
#define DINOFOS_PROB_COMPL_CHOOSE_ACTION_NOT_SLASHING_TO_SLASHING 0.35f
#define DINOFOS_PROB_COMPL_CHOOSE_ACTION_SLASHING_TO_SLASHING 0.80f
#define DINOFOS_PROB_CHOOSE_ACTION_NOT_LANDING_TO_JUMP_FORWARD 0.1f
#define DINOFOS_PROB_CHOOSE_ACTION_LANDING_TO_JUMP_FORWARD 0.05f
#define DINOFOS_PROB_CHOOSE_ACTION_TO_TURN_TO_PLAYER 0.6f
#define DINOFOS_PROB_CHOOSE_ACTION_TO_WALK 0.8f
#define DINOFOS_PROB_JUMP_FROM_PLAYER_MELEE_ATTACK 0.5f
#define DINOFOS_PROB_JUMP_BACKWARD_FROM_PLAYER_MELEE_ATTACK 0.5f

#define DINOFOS_IDLE_TIMER1_MAX_OFFSET 20.0f
#define DINOFOS_IDLE_TIMER1_MIN 40
...
#define DINOFOS_SIDESTEP_TIMER_MAX_OFFSET 10.0f
#define DINOFOS_SIDESTEP_TIMER_MIN 5

#define DINOFOS_PROB_JUMP_BACKWARD_TO_FIRE 0.6f

#define DINOFOS_FREEZE_TIMER 80
#define DINOFOS_IDLE_TIMER 30
#define DINOFOS_FIRE_TIMER 20
#define DINOFOS_DODGE_PROJECTILE_TIMER 10

#define DINOFOS_DIE_FROM_FREEZE_TIMER 3
#define DINOFOS_DMGEFF_STUN_TIMER 40
#define DINOLFOS_DMGEFF_ZORA_MAGIC_TIMER 40
